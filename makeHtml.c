...
//	info(msg);
	...
	sscanf(p,"%s",title);
	p=formatText(p);//space -> &nbsp; etc
	fprintf(client,"<html lang=\"zh-cn\"><html><head><meta charset=\"utf-8\"><title>Online</title></head><body><font color=\"115599\" size=+3>%s</font><br><hr width=\"100%%\"><br><font color=\"119966\" size=+2>%s</font></body></html>",title,p);
